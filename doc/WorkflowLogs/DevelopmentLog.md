...
[2025-11-05 16:00:00 UTC] Pomodoro: добавлен круговой сегментный индикатор вокруг цифр таймера (красный, заполняется по часовой с левого края; показывает долю оставшегося времени); внедрён ProgressRing и привязан к tick() — Правки в src/ui/pomodoro_window.go - Сборка успешна
